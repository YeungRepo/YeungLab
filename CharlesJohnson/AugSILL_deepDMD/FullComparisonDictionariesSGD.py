...
for sys_ind in range(4): 
    ...
    for r_seed in [42, 21, 7, 3]:
        ...
        # SGD with AugSILL
        times, tEs1, tEs2, tEs5, TEs1, TEs2, TEs5 = train_and_test_SGD(train_data, test_data, Kdims[sys_ind])
        ...
        # SGD with SILL
        times, tEs1, tEs2, tEs5, TEs1, TEs2, TEs5 = train_and_test_SGD(train_data, test_data, Kdims[sys_ind], dict="SILL")
        ...
        # SGD with rbfs
        times, tEs1, tEs2, tEs5, TEs1, TEs2, TEs5 = train_and_test_SGD(train_data, test_data, Kdims[sys_ind], dict="Other")
