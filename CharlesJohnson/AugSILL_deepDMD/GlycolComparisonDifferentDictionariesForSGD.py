...
for r_seed in [42, 21, 7, 3]:
    ...
    # SGD with SILL
    times, tEs1, tEs2, tEs5, TEs1, TEs2, TEs5 = train_and_test_SGD(train_data, test_data, Kdim, dict="SILL")
    new_row = {"System": system_name, "Algorithm": "SGD with SILL", "Random Seed": r_seed,
                "Kdim": Kdim, "Time": times, "Train Error1": tEs1, "Train Error2": tEs2, 
                "Train Error5": tEs5, "Test Error1": TEs1, "Test Error2": TEs2, 
                "Test Error5": TEs5}
    results_df = results_df.append(new_row, ignore_index=True)
    ...
    # SGD with rbfs
    times, tEs1, tEs2, tEs5, TEs1, TEs2, TEs5 = train_and_test_SGD(train_data, test_data, Kdim, dict="Other")
    new_row = {"System": system_name, "Algorithm": "SGD with rbfs", "Random Seed": r_seed,
                "Kdim": Kdim, "Time": times, "Train Error1": tEs1, "Train Error2": tEs2, 
                "Train Error5": tEs5, "Test Error1": TEs1, "Test Error2": TEs2, 
                "Test Error5": TEs5}
    results_df = results_df.append(new_row, ignore_index=True)
...
print(results_df)
results_df.to_excel("glycolDictComp_Feb2021.xlsx") 
results_df.to_csv("AglycolDictComp_Feb2021.csv") 